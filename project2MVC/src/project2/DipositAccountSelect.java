...
public class DipositAccountSelect extends JFrame   {
...
public void adddepositAListener(ActionListener dipositAlistener) {
		
		b1.addActionListener(dipositAlistener);
	}
...
public void addDListener(ActionListener Dlistener) {
	...
	{
		DipositAccountSelect Frame = new DipositAccountSelect();
	}
