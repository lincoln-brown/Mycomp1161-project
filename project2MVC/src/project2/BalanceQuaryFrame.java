...
public class BalanceQuaryFrame extends JFrame   {
...
public void adddMenuListener(ActionListener Menulistener) {
		
		b7.addActionListener(Menulistener);
		}

public void adddExitListener(ActionListener Exitlistener) {
	
	b8.addActionListener(Exitlistener);}
	...
	{
		BalanceQuaryFrame Frame = new BalanceQuaryFrame();
	}
